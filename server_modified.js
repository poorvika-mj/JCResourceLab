...
//  The JSX is decoded from frontend_b64_modified.txt at startup and embedded in HTML
// ═══════════════════════════════════════════════════════════════════════════
const frontendB64 = fs.readFileSync(path.join(__dirname, "frontend_b64_modified.txt"), "utf-8").trim();
const frontendJSX = Buffer.from(frontendB64, "base64").toString("utf-8");
...
<body>
  ...
  <script type="text/babel">
    // ── API helper — talks to the Express backend on the same server ──────
    ...
    // ── Your complete original frontend code below ───────────────────────
    ${frontendJSX}
  </script>
</body>
</html>`;
